...
import com.utility.BatFileShortCutGeneratorApplication;
...
public class SeleniumUtil {
    ...
    private void startApplication() throws InterruptedException {
        ...
        BatFileShortCutGeneratorApplication.main(args);
        waitSeconds(5);
    }
    ...
    protected  String getPathWithAbsolutePath(String path){
